...
- The auditable batch agent mode supports execution traces, run manifests, low-confidence review, partial resume, retry CLI options, model preflight, review decision records, and run audit reports.
